...
var ThemeContext = React__default.createContext(darkTheme);
  ...
  createClass(MenuItem, [{
    ...
    value: function handleClick(e) {
      ...
      switch (menuItem.type) {
        case 'checkbox':
          {
            ...
            menuItem.click(newMenuItem, electron.remote.getCurrentWindow(), e);
        ...
        case 'radio':
          {
            ...
            menuItem.click(_newMenuItem, electron.remote.getCurrentWindow(), e);
            if (!menuItem.checked) {
              // TODO: Change Checked State
        ...
        default:
          e.persist();
          menuItem.click(this.props.menuItem, electron.remote.getCurrentWindow(), e);
          break;
      }
    }
  }, {
...
var menuIcon = React__default.createElement(
  'svg',
  ...
  function MenuBar(props) {
    ...
    _this.generateHorizontalMenu = function () {
      ...
      return menuObj.map(function (menuItem, i) {
        return React__default.createElement(
          ...
          _this.state.clicked && i === _this.state.focusing && React__default.createElement(MenuList, {
    ...
    _this.generateVerticalMenu = function () {
      ...
      return React__default.createElement(
        ...
        _this.state.clicked && _this.state.focusing === 0 && React__default.createElement(MenuList, {
          changeCheckState: _this.changeCheckState,
...
var Bar = function (_React$Component) {
  ...
  createClass(Bar, [{
    ...
    value: function handleDoubleClick(e) {
      ...
      if (!isWin) {
        var bounds = electron__default.screen.getPrimaryDisplay().workArea;
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          isMaximized ? React__default.createElement(
            'svg',
            {
              version: '1.1',
              'aria-hidden': 'true',
      ...
      switch (platform) {
        case 'win32':
          ...
          return React__default.createElement(
            ...
            React__default.createElement(ResizeHandle, { left: true }),
            ...
            children,
            React__default.createElement(WindowControls, {
        ...
        default:
          return React__default.createElement(
            ...
            (title || app) && React__default.createElement(
              ...
              icon && currentTheme.showIconDarLin && React__default.createElement(Icon, {
                src: icon,
                onClick: onIconClick
              }),
              title || app
